	...
	>
		...
		>
			...
			<div class="flex justify-start content-center gap-2">
				<a href="https://github.com/vishal-kacha"
					><svg
						xmlns="http://www.w3.org/2000/svg"
						class="w-12 h-10 hover:fill-black fill-zinc-500"
						viewBox="0 0 512 512"
						fill="white"
					...
					></a
				>
				<a href="https://www.linkedin.com/in/vishal-kacha-32918b247">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						class="w-12 h-10 hover:fill-black fill-zinc-500"
						viewBox="0 0 512 512"
		...
		<div class="m-4">
			<div>
				...
				<div class="flex gap-4">
					<span class="py-1 px-4 border border-black">tags</span>
					<span class="py-1 px-4 border border-black">tags</span>
					<span class="py-1 px-4 border border-black">tags</span>
				</div>
			</div>
